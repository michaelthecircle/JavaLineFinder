...
public class Main {
  public static void main(String[] args) throws LineCountShouldBePositiveException {
    ...
    log.info("Введите количество строк до и после найденной строки для записи в результирующий " + "файл: ");
    int lineCount = in.nextInt();

    //String input = "inputFile.txt";
    //String output = "abobochka.txt";
    ...
    //service.find(input, output, keyWord, lineCount);
